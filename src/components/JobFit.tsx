...
export default function JobFit() {
  return (
    <div className="job-fit relative -z-0 flex h-screen w-full justify-center lg:items-center">
      <div className="container">
        <div className="grid grid-cols-1 items-center justify-between gap-6 py-10 lg:grid-cols-2 lg:py-0">
          <div className="order-2 flex flex-col gap-8 lg:order-2">
            ...
            <div className="relative z-10 w-full max-w-[34rem]">
              <input
                type="text"
                placeholder="Simply enter your email"
                className="w-full rounded-lg border border-black py-3 text-sm italic placeholder:pl-3 sm:text-base"
              />
