...
import pattern from "../../public/images/pattern/pattern1.1bfa0213.png";
...
export default function Seeing() {
  return (
    <section className="relative overflow-x-clip" id="assessment">
      <div className="bg-[#e0f2fb] bg-[url(/images/pattern/pattern1.1bfa0213.png)] bg-cover bg-center bg-no-repeat">
        ...
        <Wave />
        {/* <Image src={pattern} alt="pattern" className="absolute z-50" /> */}
      </div>
    </section>
  );
}
